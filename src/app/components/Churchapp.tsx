...
const ChurchApp = () => {
  return (
    <section className="relative flex items-center justify-center min-h-screen bg-cover bg-center bg-blue-100" style={{ backgroundImage: 'url(/app-norwalkbaptistchurch.png)' }}>
