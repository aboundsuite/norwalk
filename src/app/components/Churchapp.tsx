...
const ChurchApp = () => {
  return (
    <section className="relative flex items-center justify-center h-screen bg-cover bg-center bg-blue-100" style={{ backgroundImage: 'url(/appdownload.jpg)' }}>
      <div className="absolute inset-0 bg-black opacity-50"></div>
      <div className="relative z-10 text-center text-white p-4">
        <h1 className="text-4xl font-bold mb-4">Stay Connected 24x7</h1>
        <p className="text-lg mb-8">Connecting you with your Tabernacle community.</p>
