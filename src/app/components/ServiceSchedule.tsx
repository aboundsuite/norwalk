const ServiceSchedule = () => (
   ...
   <h2 className="text-3xl font-bold mb-4 text-blue-900 text-5xl mb-100">Service Schedule</h2>
      ...
      <div className="grid grid-cols-1 gap-20">
        <div>
          <h3 className="text-2xl font-bold mb-2 text-blue-500 mb-10">Every Sunday</h3>
        ...
        <div>
          ...
          <p className="text-xl font-normal mb-2 text-gray-600"> Lebanon, MO 65536                             7:00pm</p>
    ...
    <button className="bg-blue-900 h-20 w-50 hover:bg-blue-700 text-white px-4 py-2 rounded px-20 text-xl">Get Directions</button>
</a>
        </div>
